...
input <- output <- "output/simu7_latent_u1w3" 
ratio.u <- Inf 
u <- 1
for (outcome in c("Y")) {
  tb1 <- c()
...
################################################################
################################################################
input <- output <- "output/simu7_nonlatent_w3"
u <- 0; ratio.u <- 0
...
################################################################
################################################################
input <- output <- "output/simu7_no_adjustment"
u <- 0; ratio.u <- 0
...
saveRDS(tb2, file = "output/simu7_latent_u1w3/combined.rds")
