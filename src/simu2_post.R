...
input <- output <- "output/simu2_latent_u1w3" 
ratio.u <- Inf 
u <- 1
for (outcome in c("Y")) {
  tb1 <- c()
...
################################################################
################################################################
input <- output <- "output/simu2_nonlatent_w3"
u <- 0; ratio.u <- 0
...
################################################################
################################################################
input <- output <- "output/simu2_no_adjustment"
u <- 0; ratio.u <- 0
...
saveRDS(tb2, file = "output/simu2_latent_u1w3/combined.rds")
