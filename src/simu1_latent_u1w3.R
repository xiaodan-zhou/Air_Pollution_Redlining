...
ratio.u <- Inf
############################# load redlining data ############################# 
input.folder <- "output/simu1_randUZ_data"
dir.create("output/simu1_randUZ_mcmc_noproxy", recursive = TRUE)
dir.create("output/simu1_randUZ_mcmc_latent_u1w3", recursive = TRUE)
